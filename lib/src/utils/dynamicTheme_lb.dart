  ...
  static void switchTheme() {
    ...
    if (Platform.isAndroid) {
      ...
      SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
        ...
        //statusBarColor: loadisDArkMode()?ThemesDataApp.light.scaffoldBackgroundColor: ThemesDataApp.dark.scaffoldBackgroundColor,
        statusBarBrightness: loadisDArkMode() ? Brightness.light : Brightness.dark,
        statusBarIconBrightness: loadisDArkMode() ? Brightness.light : Brightness.dark,
    ...
    if (Platform.isAndroid) {
      SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
        systemNavigationBarColor: Get.theme.brightness == Brightness.light
            ? ThemesDataApp.light.scaffoldBackgroundColor
            : ThemesDataApp.dark.scaffoldBackgroundColor,
        //statusBarColor: Get.theme.brightness == Brightness.light? ThemesDataApp.light.scaffoldBackgroundColor: ThemesDataApp.dark.scaffoldBackgroundColor,
