    ...
    return Theme(
      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.home, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.search, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.plusSquare, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: FaIcon(FontAwesomeIcons.heart, size: 24.0),title: Text("")),
