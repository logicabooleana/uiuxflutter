    ...
    return Theme(
      ...
      child: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(Icons.home, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: Icon(Icons.credit_card, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: Icon(Icons.account_balance_wallet, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: Icon(Icons.assessment, size: 24.0),title: Text("")),
          BottomNavigationBarItem(icon: Icon(Icons.perm_contact_calendar, size: 24.0),title: Text("")),
        ],
        currentIndex: 0, 
